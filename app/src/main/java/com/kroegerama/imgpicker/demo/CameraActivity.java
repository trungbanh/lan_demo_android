...
//      threadsTextView.setText(threadsEnabled ? String.valueOf(numThreads) : "N/A");
    ...
    protected abstract void processImage(int[] myBytes);
    ...
    public void onImagesSelected(@NotNull List<? extends Uri> uris, @Nullable String tag) {
        ...
        for (Uri uri : uris) {
            ...
            Bitmap mybit = getResizedBitmap(bitmap);
            byte[] newByte = getNV21(mybit);

            imageConverter =
                    new Runnable() {
                        @Override
                        public void run() {
                            ImageUtils.convertYUV420SPToARGB8888(newByte, previewWidth, previewHeight, rgbBytes);
                        }
                    };
